                    ...
                    <CardContent>
                        ...
                        <Typography varient="h5" gutterBottom>
                            <CountUp 
                                ...
                                separator="," 
                            />
                        </Typography>                        <Typography color="textSecondary" gutterBottom>{new Date(lastUpdate).toDateString()}</Typography>
                        <Typography varient="body2" gutterBottom>Number of death caused by COVID-19</Typography>
                    </CardContent>
                </Grid>
            </Grid>
        </div>
